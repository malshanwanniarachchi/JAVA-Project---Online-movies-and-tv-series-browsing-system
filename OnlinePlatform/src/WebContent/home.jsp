...
<body>
  <div class="header-section">
    ...
    <p>The best streaming platform</p>
	    ...
	    <div id="top-free" class="carousel">
	      <%
	        ...
	        try {
	          ...
	          String sql = "SELECT * FROM app ORDER BY id ASC";
	    ...
	    <div id="top-trending" class="carousel">
	      <%
	        ...
	        try {
	          Connection connection = DBConnection.getConnection();
	          Statement statement = connection.createStatement();
	          String sql = "SELECT * FROM app ORDER BY id DESC";
	          ResultSet result = statement.executeQuery(sql);
	          while (result.next()) {
	      %>
	            <div class="app-card">
	    ...
	    <div id="top-paid" class="carousel">
	      <%
	        ...
	        try {
	          Connection connection = DBConnection.getConnection();
	          Statement statement = connection.createStatement();
	          String sql = "SELECT * FROM app ORDER BY Name ASC";
	          ResultSet result = statement.executeQuery(sql);
	          while (result.next()) {
	      %>
	            <div class="app-card">
